...

{
    ...
    "data": [
        ...
        "data/devops_gen_img_light.xml",
        "data/devops_gen_img_style_artist.xml",
        "data/devops_gen_img_style_type.xml",
        "data/devops_gen_img_texture.xml",
        ...
        "views/devops_gen_img_detail.xml",
        "views/devops_gen_img_light.xml",
        "views/devops_gen_img_style_artist.xml",
        "views/devops_gen_img_style_type.xml",
        "views/devops_gen_img_texture.xml",
        "views/devops_ide_breakpoint.xml",
        "views/devops_ide_pycharm.xml",
        "views/devops_instance_exec.xml",
        "views/devops_instance_type.xml",
