...

{
    ...
    "data": [
        ...
        "views/devops_deploy_docker_compose.xml",
        "views/devops_deploy_docker_container.xml",
        "views/devops_deploy_docker_image.xml",
        "views/devops_deploy_docker_network.xml",
        "views/devops_deploy_docker_volume.xml",
